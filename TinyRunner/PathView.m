...
{
    MovementPath *movementPath = (MovementPath *)(self.overlay);
    ...
    [movementPath lockForReading];
    CGPathRef path = [self newPathForPoints:movementPath.points
                                 pointCount:movementPath.pointCount
                                   clipRect:clipRect
                                  zoomScale:zoomScale];
    [movementPath unlockForReading];
